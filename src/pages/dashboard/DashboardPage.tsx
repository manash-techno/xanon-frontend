      ...
      <div className="flex flex-wrap -m-[10px] mt-[10px]">
        <div className="w-full xl:max-w-[50%] p-[10px]">
          <div className="h-full bg-[#FAFAFA] dark:bg-[#1A1A1A] px-[16px] py-[12px] rounded-md">
            ...
            <div className="mt-4 flex flex-col gap-4 max-h-[460px] overflow-x-hidden overflow-y-auto xl:hidden">
              <div className="flex flex-col gap-3 border-b  dark:border-[#3B3B3B] border-[#eaeaea] first-child:border-b-0 pb-4">
                <div className="flex gap-4 items-center">
                  <div className="bg-[#F0F0F0] dark:bg-[#292929] w-[40px] h-[40px] rounded-[6px] flex items-center justify-center flex-[0_0_auto]">
                    <img
                      alt=""
                  ...
                  <div className="MuiBox-root css-0">
                    <p
                      className=" text-[#1E1E1E] dark:text-[#fff] break-words whitespace-normal overflow-hidden text-ellipsis text-[12px]"
                      style={{
                    ...
                    <div className="flex flex-wrap gap-2">
                      <p className=" text-[#6E8091] dark:text-[#828282]  text-[10px]">
                        3V-YU78-8UOF
                      </p>
                      <p className=" text-[#6E8091] dark:text-[#828282]  text-[10px]">
                        B007OTJ4D4
              ...
              <div className="flex flex-col gap-3 first-child:border-b-0 pb-4">
                <div className="flex gap-4 items-center">
                  ...
                  <div className="MuiBox-root css-0">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <p className=" text-[#6E8091] text-[10px] dark:text-[#828282]">
                        3V-YU78-8UOF
                      </p>
                      <p className=" text-[#6E8091] text-[10px] dark:text-[#828282]">
                        B007OTJ4D4
        ...
        <div className="w-full xl:max-w-[50%] p-[10px]">
          <div className="h-full bg-[#FAFAFA] dark:bg-[#1A1A1A] px-[16px] py-[12px] rounded-md">
            ...
            <Box className="flex flex-col gap-4 xl:hidden max-h-[599px] overflow-x-hidden overflow-y-auto ">
              {/* start: table item */}
              <Box className="flex flex-col gap-3 border-b border-[#eaeaea] dark:border-[#3B3B3B] first-child:border-b-0 pb-4">
                <Box className="flex gap-2">
                  <div className=" text-[#1E1E1E] dark:text-[#fff] font-light text-[10px]">
                    Jul 25, 24
                  </div>
                  <div className=" text-[#6E8091] dark:text-[#828282] font-light text-[10px]">
                    11:22 AM
                  </div>
                </Box>

                <Box className="flex gap-4 items-center">
                  <Box className="bg-[#F0F0F0] dark:bg-[#292929] w-[40px] h-[40px] rounded-[6px] flex items-center justify-center flex-[0_0_auto]">
                    <img
                      src="/assets/images/box-icon.svg"
                      className="w-[16px]"
                      alt=""
                  ...
                  <Box className="">
                    ...
                    >
                      Shiseido Japan Fino Premium Touch Hair Treatm...
                    </div>
                ...
                <Box className="">
                  ...
                  >
                    <thead>
                      <tr>
                        <th className="border-b border-[#eaeaea] dark:border-b-[#3B3B3B] text-left pb-2 w-[120px]">
                          <div className="text-[#1E1E1E] dark:text-[#fff] font-normal text-[10px]">
                            Pending
                          </div>
                          <div className="text-[#6E8091] text-[10px] text-[#828282] font-normal">
                            Amazon.uk
                          </div>
                        </th>
                        <th className="border-b border-[#eaeaea] dark:border-b-[#3B3B3B] text-left pb-2 w-[90px]">
                          <div className="text-[#1E1E1E] dark:text-[#fff] font-normal text-[10px]">
                          <img alt="" src="/assets/images/ukLogo.png" className="h-[15px]" />
                          </div>
                          <div className="text-[#6E8091] text-[10px] text-[#828282] font-normal">
                            Inbound
                          </div>
                        </th>
                        <th className="border-b border-[#eaeaea] dark:border-b-[#3B3B3B] text-left pb-2 w-[50px]">
                          <div className="text-[#1E1E1E] dark:text-[#fff] font-normal text-[10px]">
                            21
                          </div>
                          <div className="text-[#6E8091] text-[10px] text-[#828282] font-normal">
                        ...
                        <th className="text-right border-b dark:border-b-[#3B3B3B] border-[#eaeaea] pb-2">
                          <div className="text-[#1E1E1E] dark:text-[#fff] font-normal text-[10px] whitespace-nowrap">
                            Quantity: 1
                          </div>
                          <div className="text-[#6E8091] text-[10px] text-[#828282] font-normal whitespace-nowrap">
                            Customer Order
                          </div>
                        </th>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td className="pt-2 align-top">
                          <div className="flex flex-col items-end">
                            ...
                            <Fragment></Fragment>
                            <span className="flex items-center cursor-pointer text-[10px]">
                            <div className="text-[#6E8091] text-[10px] text-[#828282] font-normal whitespace-nowrap">
                            More
                            </div>
                              <ReactImage
                                src={AssetsConfig.icons.chevronDown.src}
                                width={16}
                                height={16}
                              />
                            </span>
              ...
              {/* start: table item */}
              <Box className="flex flex-col gap-3 first-child:border-b-0 pb-4">
                <Box className="flex gap-2">
                  <div className=" text-[#1E1E1E] dark:text-[#fff] font-light text-[10px]">
                    Jul 25, 24
                  </div>
        ...
        <div className="w-full xl:max-w-[50%] p-[10px]">
          <div className="h-full bg-[#FAFAFA] dark:bg-[#1A1A1A] px-[16px] py-[12px] rounded-md">
            ...
            <div className="mt-4 flex flex-col gap-4 xl:hidden max-h-[481px] overflow-x-hidden overflow-y-auto">
              <div className="flex flex-col gap-1 border-b border-[#eaeaea] dark:border-[#3B3B3B] first-child:border-b-0 pb-4">
                <div className="flex gap-2">
                  <p className=" text-[#1E1E1E] dark:text-[#fff] font-light text-[10px]">
                    Jul 25, 24
                  </p>
                  <p className=" text-[#6E8091] dark:text-[#828282] font-light text-[10px]">
                    11:22 AM
                  </p>
                </div>
                <div className="flex gap-1 items-center">
                  <p className=" text-[#1E1E1E] dark:text-[#fff] text-[12px]">
                    203-4886959-8683560
                  </p>
                  <svg
                ...
                <div className="flex gap-1 items-center">
                  ...
                  <div className="font-normal text-md leading-[150%] tracking-[-1%] text-[#0077E5] text-[12px]">
                    +2
                  </div>
                </div>
                <div className="flex gap-4 items-center">
                  ...
                  <div className="text-[#1E1E1E] dark:text-[#F2F2F2] font-normal text-[10px] leading-[150%] tracking-[-1%] flex-[0_0_auto] ml-auto pl-2">
                    6
                  </div>
                </div>
              </div>
              <div className="flex flex-col gap-3 border-b border-[#eaeaea] dark:border-[#3B3B3B] first-child:border-b-0 pb-4">
                <div className="flex gap-2">
                  <p className=" text-[#1E1E1E] dark:text-[#fff] font-light text-[10px]">
                    Jul 25, 24
                  </p>
