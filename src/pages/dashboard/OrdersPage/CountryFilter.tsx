...
import { setSelectedCountry } from "@/store/slices/orderSlice";
...
export const CountryFilter = () => {
    ...
    const selectedCountry = useSelector((state: RootState) => state.order.selectedCountry);
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent
                align="start"
                className="z-50 w-full md:w-60 h-60 overflow-y-auto rounded-md border bg-white p-1 text-gray-900
