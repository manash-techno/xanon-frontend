...
import { setSelectedStatus } from "@/store/slices/orderSlice";
import { orderStatusList, EnumOrderStatus } from "@/constants/filter.ts";
...
export const StatusFilter = () => {
    ...
    const selectedStatus = useSelector((state: RootState) => state.order.selectedStatus) || EnumOrderStatus.All;
