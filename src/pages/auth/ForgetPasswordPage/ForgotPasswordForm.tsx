...
import {Fragment, JSX, memo, useEffect, useState} from "react";
...
const ForgotPasswordFormComponent = ({ onSuccess }: ForgetPasswordViewProps): JSX.Element => {
    ...
    return <Fragment>
        ...
        <div className="text-xs text-center text-gray-700 dark:text-gray-300">
            ...
            <Link className="text-[#0077E5] dark:text-[#68A0FF] font-semibold ml-1"
