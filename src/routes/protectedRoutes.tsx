...
export const protectedRoutes: RouteObject[] = [
    {
        ...
        children: [
            ...
            { path: "reprice/rules", element: lazyLoader(() => import("@/pages/dashboard/RepricesPage/Rules"))},
            { path: "reprice/rules/add", element: lazyLoader(() => import("@/pages/dashboard/RepricesPage/Rules/AddEdit"))},
            { path: "reprice/rules/edit/:id", element: lazyLoader(() => import("@/pages/dashboard/RepricesPage/Rules/AddEdit"))},
            ...
            { path: "expenses/add", element: lazyLoader(() => import("@/pages/dashboard/ExpensesPage/AddEdit"))},
            { path: "expenses/edit/:id", element: lazyLoader(() => import("@/pages/dashboard/ExpensesPage/AddEdit"))},
            {
                path: "reconciliation",
